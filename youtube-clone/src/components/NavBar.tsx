...
export default function NavBar() {
    ...
    return (
        <header className="sticky top-0 z-50 bg-white/80 dark:bg-[#0f172a]/80 backdrop-blur-md border-b border-gray-200 dark:border-gray-800 transition-colors duration-300">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-16">
                    ...
                    >
                        ...
                        <span className="hidden sm:inline bg-gradient-to-r from-teal-500 to-blue-500 bg-clip-text text-transparent">StreamSummarize</span>
                        <span className="sm:hidden">SS</span>
                    </Link>

                    {/* Search Bar - Hidden on mobile initially or collapsible? Keeping as is for now but styled */}
